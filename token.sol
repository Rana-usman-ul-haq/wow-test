...
contract WOW is Context, IERC20, Ownable {
    ...
    address payable public _taxWallet = payable(0x7560F4D10249439Dd401f15a780583a98addD82E);


    uint256 private _buyTax = 20; //Buy fee
    uint256 private _sellTax = 20; // sell fee


    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 420690000000 * 10**_decimals; // Total supply
    string private constant _name = unicode"Wow Token";  // Name
    string private constant _symbol = unicode"WOW"; // Symbol
